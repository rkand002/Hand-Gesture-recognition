...
% Last Modified by GUIDE v2.5 07-Dec-2017 21:42:01
...
% --- Executes on button press in registerBtn.
function registerBtn_Callback(hObject, eventdata, handles)
% hObject    handle to registerBtn (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
%closereq;
%in first gui
%fig1 = main();          %first GUI's figure handle
%fig2 = register();    %returns second GUI's figure handle
